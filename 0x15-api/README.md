...
This is an API projects. Data used were obtained from the
[JSONPlaceholder REST API](https://jsonplaceholder.typicode.com/), and I also learned how to export it to either CSV or JSON format.
